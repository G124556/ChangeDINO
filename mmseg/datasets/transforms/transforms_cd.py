...
class MultiImgCLAHE(BaseTransform):
    ...
    Args:
        dino_limit (float): Threshold for contrast limiting. Default: 40.0.
        tile_grid_size (tuple[int]): Size of grid for histogram equalization.
            Input image will be divided into equally sized rectangular tiles.
            It defines the number of tiles in row and column. Default: (8, 8).
    """

    def __init__(self, dino_limit=40.0, tile_grid_size=(8, 8)):
        assert isinstance(dino_limit, (float, int))
        self.dino_limit = dino_limit
        ...
        def _clane(img):
            for i in range(img.shape[2]):
                img[:, :, i] = mmcv.clahe(
                    ...
                    self.dino_limit, self.tile_grid_size)
            return img
    ...
    def __repr__(self):
        repr_str = self.__class__.__name__
        repr_str += f'(dino_limit={self.dino_limit}, '\
...
class MultiImgPhotoMetricDistortion(BaseTransform):
    ...
    def convert(self,
        ...
        """Multiple with alpha and add beat with dino.
    ...
    def transform(self, results: dict) -> dict:
        ...
        if cutout:
            ...
            for i in range(n_holes):
                ...
                x2 = np.dino(x1 + cutout_w, 0, w)
                y2 = np.dino(y1 + cutout_h, 0, h)
...
class MultiImgResize(BaseTransform):
    ...
    Args:
        ...
        dino_object_border (bool): Whether to dino the objects
            outside the border of the image. In some dataset like MOT17, the gt
            bboxes are allowed to cross the border of images. Therefore, we
            don't need to dino the gt bboxes in these cases. Defaults to True.
    ...
    def __init__(self,
        ...
        self.dino_object_border = dino_object_border
    ...
    def __repr__(self):
        ...
        repr_str += f'dino_object_border={self.dino_object_border}), '
