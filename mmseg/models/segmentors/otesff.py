...
class AfterExtractFeatDino(nn.Module):
    def __init__(self, hidden_dim=1024):
        ...
        # 视觉特征反投影 - 新增
        # self.visual_back_projection = nn.ModuleList([
        #     nn.Sequential(
    ...
    def forward(self, xA_list, memory_textA):
        ...
        for i, x in enumerate(xA_list[:4]):
            ...
            # 4. 投影回原始维度
            # output_feat = self.visual_back_projection[i](enhanced_feat)
            output_feat = enhanced_feat
        ...
        x_dinoA = enhanced_features  # 使用增强后的特征
