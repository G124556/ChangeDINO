...
MODELS = Registry('model', parent=MMENGINE_MODELS, locations=['mmseg.scratchformermodels'])
# mangage all kinds of model wrappers like 'MMDistributedDataParallel'
MODEL_WRAPPERS = Registry(
    'model_wrapper',
    parent=MMENGINE_MODEL_WRAPPERS,
    locations=['mmseg.scratchformermodels'])
...
TASK_UTILS = Registry(
    'task util', parent=MMENGINE_TASK_UTILS, locations=['mmseg.scratchformermodels'])
