...
from GDINO.groundingdino.util import box_ops, get_tokenlizer
from GDINO.groundingdino.util.misc import (
    NestedTensor,
    accuracy,
    get_world_size,
    interpolate,
...
class GroundingDINO(nn.Module):
    ...
    def forward(self, samples: NestedTensor, targets: List = None, **kw):
        ...
        # hs, reference, hs_enc, ref_enc, init_box_proposal = self.transformer(  #修改过
        hs, reference, hs_enc, ref_enc, init_box_proposal,memory, memory_text,pos = self.transformer(
        ...
        # return out
        # return out ,poss #修改过
        return out ,memory,memory_text,reference,pos
